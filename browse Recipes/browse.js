...
function applyTimeFilter(filter) {
    // Implement your logic to apply the time filter
    // For now, let's just print the selected filter to the console
    console.log("Time filter applied:", filter);

    // You can close the popup after applying the filter if needed
    closeTimePopup();
}
...
function showRecipeDetails(recipe) {
    ...
    sidebar.innerHTML = `
      <button onclick="toggleSidebar()" style="margin: 0 10px;
      padding: 8px 15px;
      border: none;
      border-radius: 5px;
      ...
      <button style="-webkit-border-radius: 60;
      ...
      text-decoration: none; style="">View Recipe</button>
