...
function showRecipeDetails(recipe) {
  ...
  sidebar.innerHTML = `
    <img src="./img/fp-fp-2149056043.jpg" style=" width: 100%; height: 30%; object-fit: cover;"></img>
           <a onclick="toggleSidebar()" class = "closebtn" href="javascript:void(0)"><i class="fa fa-times" ></i></a>
    <h2 style="margin-left:2%;">${
      recipe.querySelector(".recipe-details h2").textContent
    }</h2>
    ...
    <p style="margin-left:2%;">${
      recipe.querySelector(".recipe-details p").textContent
    }</p>
    <div class="rating" style="margin-left:2%; margin-right:10%">${
      recipe.querySelector(".rating").innerHTML
    }(9.7k)</div>
...
function showRecipeDetails2(recipe) {
  ...
  sidebar.innerHTML = `
    ...
    <button class = "view-recipe-btn" onclick = "window.location.href='../View Recipe Steps/view-burger.html';" class = "view-recipe-btn">View Recipe</button>
    <!-- Add more details or content as needed -->
  `;
  sidebar.classList.add("active"); // Show the sidebar by adding 'active' class
}
...
function showRecipeDetails3(recipe) {
  ...
  sidebar.innerHTML = `
    ...
    <button onclick = "window.location.href='../View Recipe Steps/view-lobster.html';" 
    class="view-recipe-btn">View Recipe</button>
    <!-- Add more details or content as needed -->
  `;
  sidebar.classList.add("active"); // Show the sidebar by adding 'active' class
}
...
function showRecipeDetails4(recipe) {
  ...
  sidebar.innerHTML = `
    ...
    <button onclick = "window.location.href='../View Recipe Steps/view-pizza.html';"
...
function showRecipeDetails6(recipe) {
  ...
  sidebar.innerHTML = `
    ...
    <button onclick = "window.location.href='../View Recipe Steps/view-mongolian.html';" 
    class="view-recipe-btn"
 >View Recipe</button>
    <!-- Add more details or content as needed -->
  `;
